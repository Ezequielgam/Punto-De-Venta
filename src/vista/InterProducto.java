...
public class InterProducto extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txt_codigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 140, 170, -1));
    ...
    private void jButton_GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GuardarActionPerformed
        ...
        //validar campos
        if (txt_nombre.getText().equals("") || txt_cantidad.getText().equals("") || txt_precio.getText().equals("")|| txt_codigo.getText().equals("")) {
                        ...
                        try {
                            ...
                            *Si el usuario ingresa , (coma) como punto decimal,
                            ...
                            try {
                                ...
                                // Manejo de errores en caso de que el texto no sea un número válido
                                e.printStackTrace();
                            }
                            //Porcentaje IVA
    ...
    private int IdCategoria() {
        String sql = "select * from tb_categoria where codigo = '" + this.jComboBox_categoria.getSelectedItem() + "'";
        Statement st;
        try {
            Connection cn = Conexion.conectar();
            st = cn.createStatement();
